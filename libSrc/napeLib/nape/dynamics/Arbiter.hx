...
class Arbiter{
    ...
    inline function get_state():PreFlag{
        ...
        return switch(zpp_inner.immState){
            case ZPP_Flags.id_ImmState_ACCEPT|ZPP_Flags.id_ImmState_ALWAYS:PreFlag.ACCEPT;
            case ZPP_Flags.id_ImmState_ACCEPT:PreFlag.ACCEPT_ONCE;
            case ZPP_Flags.id_ImmState_IGNORE|ZPP_Flags.id_ImmState_ALWAYS:PreFlag.IGNORE;

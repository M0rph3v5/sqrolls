...
class Listener{
    ...
    inline function get_type():ListenerType{
        return[ListenerType.BODY,ListenerType.CONSTRAINT,ListenerType.INTERACTION,ListenerType.PRE][zpp_inner.type];
    }
    /**
    ...
    inline function get_event():CbEvent{
        return[CbEvent.BEGIN,CbEvent.END,CbEvent.WAKE,CbEvent.SLEEP,CbEvent.BREAK,CbEvent.PRE,CbEvent.ONGOING][zpp_inner.event];
    }
